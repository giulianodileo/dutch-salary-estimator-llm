...
#            title="📊 Net Salary vs Average City Expenses",
...
page = st.sidebar.radio("Go to:", ["💶 Salary Calculator", "🤖 Salary & Budget Chat", ":question: Help"])
...
# -------------------- PAGE 2: LLM CHAT --------------------
    ...
    st.title("🤖 Ask about Your Salary & Budget")
