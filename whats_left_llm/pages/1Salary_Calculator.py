...
# Add clean label helper
def clean_label(text: str) -> str:
    """Clean up the labels provided in the user input page"""
...
# Build cleaned versions and keep mapping
...
cars_display = [clean_label(car) for car in opts["cars"]]
