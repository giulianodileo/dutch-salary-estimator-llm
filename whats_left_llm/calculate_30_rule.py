...
#####################################################################
# DERIVING 30% RULING BASED ON PARAMETERS, USED IN THE MAN FUNCTION #
#####################################################################
...
##########################################################################
# MAIN FUNCTION CALCULATES TAXABLE INCOME FROM SALARY                    #
# RETURNS my_dict                                                        #
##########################################################################
...
if __name__ == "__main__":
    ...
    # Example usage
    result = expat_ruling_calc(28, 40000, "2025-01-25", 10, True, True)
    print(result)
